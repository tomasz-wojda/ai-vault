...
`integrations/` is the **required target layout** for service credentials and CLI
...
- Reference Jira credentials in worklogs by path only: `integrations/jira/jira.properties`
