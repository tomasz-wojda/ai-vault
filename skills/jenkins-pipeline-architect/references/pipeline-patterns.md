# Jenkins Pipeline Patterns — Extended Reference

Detailed patterns referenced by [SKILL.md](../SKILL.md). Read this file only when the
task involves the subjects below; the core rules live in SKILL.md.
